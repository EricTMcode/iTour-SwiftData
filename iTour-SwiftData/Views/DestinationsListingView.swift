...
struct DestinationsListingView: View {
...
#Preview {
    DestinationsListingView(sort: [SortDescriptor(\Destination.name)], searchString: "", minimumDate: .distantPast)
}
